...
void CNetworkCodingFileDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, Step_info);
}
...
BEGIN_MESSAGE_MAP(CNetworkCodingFileDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_Select, &CNetworkCodingFileDlg::OnBnClickedSelect)
	ON_BN_CLICKED(IDC_Code, &CNetworkCodingFileDlg::OnBnClickedCode)
	ON_BN_CLICKED(IDC_Recovery, &CNetworkCodingFileDlg::OnBnClickedRecovery)
	ON_BN_CLICKED(IDC_Clear, &CNetworkCodingFileDlg::OnBnClickedClear)
	ON_BN_CLICKED(IDC_Recode, &CNetworkCodingFileDlg::OnBnClickedRecode)
	ON_BN_CLICKED(IDC_BrowseFiles, &CNetworkCodingFileDlg::OnBnClickedBrowsefiles)
END_MESSAGE_MAP()
...
void CNetworkCodingFileDlg::OnBnClickedSelect()
{
...
void CNetworkCodingFileDlg::OnBnClickedCode()
{
	// TODO: Add your control notification handler code here
	/************************************************************************/
...
void CNetworkCodingFileDlg::OnBnClickedRecovery()
{
	// TODO: Add your control notification handler code here
	if (g_flag != 2){
		if (g_flag == 0){
...
void CNetworkCodingFileDlg::OnBnClickedClear()
{
	// TODO: Add your control notification handler code here
	//删除执行中产生的.nc文件
	if (g_flag != 2){
...
void CNetworkCodingFileDlg::OnBnClickedRecode()
{
	// TODO: Add your control notification handler code here
	if (g_flag != 2){
		if (g_flag == 0){
...
void CNetworkCodingFileDlg::OnBnClickedBrowsefiles()
{
	// TODO: Add your control notification handler code here
	TCHAR szPath[MAX_PATH];
	GetModuleFileName(NULL, szPath, MAX_PATH);
